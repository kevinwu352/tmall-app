...
public class KlineView: BaseView {
  public override func setup() {
    super.setup()
    chg.backgroundColor(.kline_background)
  ...
  public var content_width = SCREEN_WID
